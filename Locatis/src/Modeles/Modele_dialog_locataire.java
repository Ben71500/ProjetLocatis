...
public class Modele_dialog_locataire {
    ...
    /**
     * Méthode qui recherche les campagnes dont un locataire fait partie
    ...
    public ArrayList<Campagne> getListeCampagne(int idLocataire){
        ...
        ArrayList<Integer> listIdListDiff = (ArrayList<Integer>) listDao.searchListLocataireByIdLocataire(idLocataire);
